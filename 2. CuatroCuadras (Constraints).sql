...
ALTER TABLE LUGAR ADD CONSTRAINT FK_IDEtiq FOREIGN KEY (ID_Etiqueta) REFERENCES ETIQUETA(ID_Etiqueta) ON DELETE NO ACTION ON UPDATE CASCADE
GO
...
ALTER TABLE CIUDAD ADD CONSTRAINT Check_Ciudad CHECK (Ciudad NOT LIKE '^[A-Za-zÁÉÍÓÚáéíóúñÑ ]+$')
GO
