...
ALTER TABLE VISITA ADD CONSTRAINT FK_Nickname FOREIGN KEY (Nickname) REFERENCES Usuario(Nickname) ON DELETE NO ACTION ON UPDATE CASCADE
GO
...
ALTER TABLE AMIGO ADD CONSTRAINT FK_Nickname2 FOREIGN KEY (Nickname2) REFERENCES Usuario(Nickname) ON DELETE NO ACTION ON UPDATE CASCADE
GO

ALTER TABLE AMIGO ADD CONSTRAINT U_Amigo UNIQUE (Nickname1,Nickname2)
GO

ALTER TABLE AMIGO ADD CONSTRAINT Check_EstadoAmigo CHECK (Estado IN ('P','A','R'))
GO
...
ALTER TABLE CIUDAD ADD CONSTRAINT Check_Ciudad CHECK (Ciudad NOT LIKE '%[^A-Z]%')
GO

ALTER TABLE CIUDAD ADD CONSTRAINT U_Ciudad UNIQUE (Ciudad)
GO